...
local brightness = require("brightness_linux")
...
vicious.register(soundwidget, vicious.widgets.volume, " $2<span color='#ffffff'>$1</span>", 2, "Master")
--
brightnesswidget = wibox.widget.textbox()
vicious.register(brightnesswidget, brightness, " 💡<span color='#ffffff'>$1%</span>", 2)
--
wifiwidget = wibox.widget.textbox()
vicious.register(wifiwidget, vicious.widgets.wifiiw, " 📶<span color='#ffffff'>${ssid}</span>", 60, "wlp3s0")
